...
//
// This file lives in the nested `IntegrationTests` package. The root
// `swift test` never sees it, because the root manifest does not declare
// this target. This suite runs under
...
/// The gated agent-process scenarios over stdio.
///
/// Serialized and time-limited, in the same way as every gated suite in
/// the sibling package FoundationModelsMultitool. Each test here spawns a
